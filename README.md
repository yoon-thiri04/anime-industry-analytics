...
An end-to-end final year **IS-212 Data & Knowledge Mining** project supervised by **Dr. Hsu Myat Mo**, covering MyAnimeList data collection via the **Jikan API**, descriptive mining, text mining, recommendation, predictive modeling, future forecasting, model inference, and web UI development.
